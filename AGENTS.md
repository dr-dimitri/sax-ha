...
- Cover real tariff/source changes during both device acknowledgement phases
  ...
  Test all dashboard time inputs (tariff editor and grid-serving window) in
  Chromium and WebKit with keyboard entry and commit events, including
  incomplete hours, midnight and multiple windows; run the
