...
# ==========================================================================
# Entladesperre / preisgesteuertes Aufsparen (siehe anforderung.yaml,
# REQ-DISCHARGE-BLOCK)
# ==========================================================================
# Vierte, ENTLADEseitige Automatik neben den drei Lade-Automatiken: hält den
# Speicher über denselben SunSpec-Schreibpfad (Register 40051 = 1, Register
# 40049 = 0 %) aktiv auf einem 0-W-Sollwert, statt ihn den Hausverbrauch
# decken zu lassen - der Hausverbrauch geht währenddessen ans Netz, weil der
# Strom in diesem Moment billig ist, und die gespeicherte Energie bleibt für
# die teure Abendspitze übrig. Kein eigener Schreib-Task: die Entscheidung
# fällt in SaxPowerCoordinator._async_enforce_grid_charge als unterste Stufe
# der Vorrangkette, ausgeführt über async_start_sun_charge(0)/
# async_stop_sun_charge.
DISCHARGE_BLOCK_MODE_OFF = "off"
DISCHARGE_BLOCK_MODE_WINDOW = "window"
DISCHARGE_BLOCK_MODE_PRICE = "price"
DISCHARGE_BLOCK_MODES = (
    DISCHARGE_BLOCK_MODE_OFF,
    DISCHARGE_BLOCK_MODE_WINDOW,
    DISCHARGE_BLOCK_MODE_PRICE,
)
DEFAULT_DISCHARGE_BLOCK_MODE = DISCHARGE_BLOCK_MODE_OFF

# Default-Zeitfenster bewusst leer (Start == Ende, siehe
# SaxPowerCoordinator._is_time_in_window): der Modus "window" sperrt erst,
# nachdem der Anwender ein echtes Fenster gesetzt hat.
DEFAULT_DISCHARGE_BLOCK_START = "00:00"
DEFAULT_DISCHARGE_BLOCK_END = "00:00"

# Reserve, unterhalb derer nie gesperrt wird: ein fast leerer Speicher soll
# nicht sinnlos gehalten werden, sondern seine Restenergie noch nutzen
# dürfen. Preisgrenze des Modus "price" teilt sich Wertebereich und
# Schrittweite mit der Preisgrenze des preisoptimierten Ladens
# (MIN_PRICE_LIMIT/MAX_PRICE_LIMIT/PRICE_LIMIT_STEP oben).
DEFAULT_DISCHARGE_BLOCK_MIN_SOC = 20
DEFAULT_DISCHARGE_BLOCK_MAX_PRICE = 0.20

# Statustexte des Sensors "Entladesperre Status" - deutsche Klartexte,
# analog zu PRICE_STATUS_* oben. Die Reihenfolge, in der sie vergeben
# werden, entspricht der Auswertungsreihenfolge in
# SaxPowerCoordinator._discharge_block_status_text.
DISCHARGE_BLOCK_STATUS_OFF = "Aus"
DISCHARGE_BLOCK_STATUS_BLOCKING = "Entladen gesperrt"
DISCHARGE_BLOCK_STATUS_WAITING_WINDOW = "Außerhalb Sperrzeit"
DISCHARGE_BLOCK_STATUS_WAITING_PRICE = "Preis über Schwelle"
DISCHARGE_BLOCK_STATUS_NO_PRICE_DATA = "Keine Preisdaten"
DISCHARGE_BLOCK_STATUS_PAUSED_CHARGING = "Pausiert (Ladeautomatik aktiv)"
DISCHARGE_BLOCK_STATUS_PAUSED_PV_SURPLUS = "Pausiert (PV-Überschuss)"
DISCHARGE_BLOCK_STATUS_PAUSED_MIN_SOC = "Pausiert (Mindest-SOC)"
DISCHARGE_BLOCK_STATUS_PAUSED_MAX_SOC = "Pausiert (Max-SOC-Sperre)"

SERVICE_SET_DISCHARGE_BLOCK_WINDOW = "set_discharge_block_window"
