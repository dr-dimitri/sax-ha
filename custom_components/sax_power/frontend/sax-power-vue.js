...
var dt = class {
	...
	set(e, t, n, r) {
		...
		return e === /* @__PURE__ */ R(r) && s && (o ? j(n, i) && Ze(e, "set", t, n, i) : Ze(e, "add", t, n)), s;
	}
	deleteProperty(e, t) {
...
var Wt = class {
	...
	set value(e) {
		...
		e = n ? e : /* @__PURE__ */ R(e), j(e, t) && (this._rawValue = e, this._value = n ? e : Bt(e), this.dep.trigger());
	}
};
function V(e) {
...
function ur(e) {
	...
	return n.dirs && (b = ci(b, null, !1, !0), b.dirs = b.dirs ? b.dirs.concat(n.dirs) : n.dirs), n.transition && Rn(Pn(b.type) && Ln(b) || b, n.transition), v = b, Cn(_), v;
}
var dr = (e) => {
	let t;
...
var Er = (e) => e === "_" || e === "_ctx" || e === "$stable", Dr = (e) => d(e) ? e.map(ui) : [ui(e)], Or = (e, t, n) => {
	if (t._n) return t;
	let r = wn((...e) => Dr(t(...e)), n);
	return r._c = !1, r;
}, kr = (e, t, n) => {
...
function Fr(e, i) {
	...
	let { insert: o, remove: s, patchProp: c, createElement: l, createText: u, createComment: d, setText: f, setElementText: p, parentNode: m, nextSibling: h, setScopeId: g = r, insertStaticContent: _ } = e, v = (e, t, n, r = null, i = null, a = null, o = void 0, s = null, c = !!t.dynamicChildren) => {
		if (e === t) return;
		e && !ni(e, t) && (r = he(e), de(e, i, a, !0), e = null), t.patchFlag === -2 && (c = !1, t.dynamicChildren = null);
		...
		if (d = e.el = l(e.type, a, m && m.is, m), h & 8 ? p(d, e.children) : h & 16 && D(e.children, d, null, r, i, Ir(e, a), s, u), _ && En(e, null, r, "created"), E(d, e, e.scopeId, s, r), m) {
		...
		v && g.beforeEnter(d), o(d, t, n), ((f = m && m.onVnodeMounted) || v || _) && G(() => {
			try {
				f && mi(f, r, e), v && g.enter(d), _ && En(e, null, r, "mounted");
			} finally {}
		}, i);
	}, E = (e, t, n, r, i) => {
		...
		if (r && Lr(r, !1), (g = h.onVnodeBeforeUpdate) && mi(g, r, n, e), f && En(n, e, r, "beforeUpdate"), r && Lr(r, !0), d && (!e.dynamicChildren || e.dynamicChildren.length !== d.length) && (u = 0, s = !1, d = null), (m.innerHTML && h.innerHTML == null || m.textContent && h.textContent == null) && p(l, ""), d ? k(e.dynamicChildren, d, l, r, i, Ir(n, a), o) : s || se(e, n, l, null, r, i, Ir(n, a), o, !1), u > 0) {
			if (u & 16) A(l, m, h, r, a);
		...
		((g = h.onVnodeUpdated) || f) && G(() => {
			g && mi(g, r, n, e), f && En(n, e, r, "updated");
		}, i);
	}, k = (e, t, n, r, i, a, o) => {
		for (let s = 0; s < t.length; s++) {
			let c = e[s], l = t[s], u = c.el && (c.type === K || !ni(c, l) || c.shapeFlag & 198) ? m(c.el) : n;
		...
		h && (c = c ? c.concat(h) : h), e == null ? (o(d, n, r), o(f, n, r), D(t.children || [], n, f, i, a, s, c, l)) : p > 0 && p & 64 && m && e.dynamicChildren && e.dynamicChildren.length === m.length ? (k(e.dynamicChildren, m, n, i, a, s, c), (t.key != null || i && t === i.subTree) && zr(e, t, !0)) : se(e, t, n, f, i, a, s, c, l);
	}, j = (e, t, n, r, i, a, o, s, c) => {
		...
		let s = () => {
			if (e.isMounted) {
				...
				let u = t, d;
				Lr(e, !1), t ? (t.el = c.el, M(e, t, o)) : t = c, n && ne(n), (d = t.props && t.props.onVnodeBeforeUpdate) && mi(d, s, t, c), Lr(e, !0);
				let f = ur(e), p = e.subTree;
				e.subTree = f, v(p, f, m(p.el), he(p), e, i, a), t.el = f.el, u === null && gr(e, f.el), r && G(r, i), (d = t.props && t.props.onVnodeUpdated) && G(() => mi(d, s, t, c), i);
			} else {
				let o, { el: s, props: c } = t, { bm: l, m: u, parent: d, root: f, type: p } = e, m = Gn(t);
				if (Lr(e, !1), l && ne(l), !m && (o = c && c.onVnodeBeforeMount) && mi(o, d, t), Lr(e, !0), s && ye) {
					let t = () => {
		...
		if (g && (_ = o && o.onVnodeBeforeUnmount) && mi(_, t, e), u & 6) pe(e.component, n, r);
		else {
			if (u & 128) {
		...
		(g && (_ = o && o.onVnodeUnmounted) || h || v) && G(() => {
			_ && mi(_, t, e), h && En(e, null, t, "unmounted"), v && (e.el = null);
		}, n);
	}, N = (e) => {
		...
		Hr(c), Hr(l), r && ne(r), i.stop(), a && (a.flags |= 8, de(o, e, t, n)), s && G(s, t), G(() => {
			e.isUnmounted = !0;
		}, t);
...
function zr(e, t, n = !1) {
	...
	if (d(r) && d(i)) for (let e = 0; e < r.length; e++) {
		let t = r[e], a = i[e];
		a.shapeFlag & 1 && !a.dynamicChildren && ((a.patchFlag <= 0 || a.patchFlag === 32) && (a = i[e] = di(i[e]), a.el = t.el), !n && a.patchFlag !== -2 && zr(t, a)), a.type === Kr && (a.patchFlag === -1 && (a = i[e] = di(a)), a.el = t.el), a.type === qr && !a.el && (a.el = t.el);
	}
}
function Br(e) {
...
var K = /* @__PURE__ */ Symbol.for("v-fgt"), Kr = /* @__PURE__ */ Symbol.for("v-txt"), qr = /* @__PURE__ */ Symbol.for("v-cmt"), Jr = /* @__PURE__ */ Symbol.for("v-stc"), Yr = [], Xr = null;
function q(e = !1) {
	Yr.push(Xr = e ? null : []);
}
function Zr() {
	Yr.pop(), Xr = Yr[Yr.length - 1] || null;
}
var Qr = 1;
function $r(e, t = !1) {
	Qr += e, e < 0 && Xr && t && (Xr.hasOnce = !0);
}
function ei(e) {
	return e.dynamicChildren = Qr > 0 ? Xr || n : null, Zr(), Qr > 0 && Xr && Xr.push(e), e;
}
...
var ri = ({ key: e }) => e ?? null, ii = ({ ref: e, ref_key: t, ref_for: n }) => (typeof e == "number" && (e = "" + e), e == null ? null : g(e) || /* @__PURE__ */ z(e) || h(e) ? {
	i: xn,
	r: e,
	k: t,
	f: !!n
...
function X(e, t = null, n = null, r = 0, i = null, a = e === K ? 0 : 1, o = !1, s = !1) {
	...
	return s ? (fi(c, n), a & 128 && e.normalize(c)) : n && (c.shapeFlag |= g(n) ? 8 : 16), Qr > 0 && !o && Xr && (c.patchFlag > 0 || a & 6) && c.patchFlag !== 32 && Xr.push(c), c;
}
var ai = oi;
function oi(e, t = null, n = null, r = 0, i = null, a = !1) {
	if ((!e || e === Zn) && (e = qr), ti(e)) {
		let r = ci(e, t, !0);
		return n && fi(r, n), Qr > 0 && !a && Xr && (r.shapeFlag & 6 ? Xr[Xr.indexOf(e)] = r : Xr.push(r)), r.patchFlag = -2, r;
	}
...
function li(e = " ", t = 0) {
	return ai(Kr, null, e, t);
}
function Z(e = "", t = !1) {
	return t ? (q(), Y(qr, null, e)) : ai(qr, null, e);
}
function ui(e) {
	return e == null || typeof e == "boolean" ? ai(qr) : d(e) ? ai(K, null, e.slice()) : ti(e) ? di(e) : ai(Kr, null, String(e));
}
function di(e) {
...
var Qa = ["aria-busy"], $a = { class: "entity-control__name" }, eo = [
	...
	key: 1,
	role: "status"
}, po = ["aria-labelledby", "aria-describedby"], mo = ["id"], ho = ["id"], go = { class: "entity-control__confirmation-actions" }, _o = ["disabled"], vo = /*@__PURE__*/ U({
	...
	setup(e) {
		...
		return (t, n) => r.value ? (q(), J("form", {
			...
			e.monthTile && e.domain === "switch" ? (q(), J("label", {
				...
				"aria-describedby": s,
				onChange: k
			}, null, 40, eo)])) : (q(), J(K, { key: 1 }, [X("div", to, [X("label", {
				for: o,
			...
			}, [e.hideConfirmedLabel ? Z("", !0) : (q(), J("span", no, P(v.value.confirmed) + ":", 1)), li(" " + P(_.value), 1)]))]), X("div", ro, [e.domain === "switch" ? (q(), J("label", {
				key: 0,
				for: o,
				...
				onChange: k
			}, null, 40, io)], 2)) : e.domain === "select" ? (q(), J("select", {
				key: 1,
				id: o,
				...
				"aria-describedby": g.value,
				onChange: A
			}, [r.value.available ? Z("", !0) : (q(), J("option", oo, P(v.value.unavailable), 1)), (q(!0), J(K, null, W(m.value, (e) => (q(), J("option", {
				key: e,
				value: e
			}, P(ee(e)), 9, so))), 128))], 40, ao)) : (q(), J(K, { key: 2 }, [X("input", {
				id: o,
				value: l.value,
			...
			}, P(v.value.apply), 9, lo)], 64))])], 64)),
			X("div", {
				id: s,
				class: "entity-control__feedback"
			}, [r.value.error ? (q(), J("p", uo, P(r.value.error), 1)) : b.value ? (q(), J("p", fo, P(b.value), 1)) : Z("", !0)]),
			e.confirmSwitch ? (q(), J("dialog", {
				...
				onCancel: Fa(E, ["prevent"]),
				onClose: D
			}, [
				X("h3", { id: `${V(a)}-confirmation-title` }, P(v.value.confirmationTitle), 9, mo),
				X("p", { id: `${V(a)}-confirmation-question` }, P(v.value.confirmationQuestion), 9, ho),
				X("div", go, [X("button", {
					type: "button",
					autofocus: "",
					onClick: E
				}, P(v.value.cancel), 1), X("button", {
					type: "button",
					disabled: y.value || !d.value,
					onClick: O
				}, P(d.value?.desired ? v.value.turnOn : v.value.turnOff), 9, _o)])
			], 40, po)) : Z("", !0)
		], 42, Qa)) : Z("", !0);
	}
	...
	setup(e) {
		...
		return (t, n) => r.value ? (q(), J("section", {
			...
			}, null, -1), o.value === null ? Z("", !0) : (q(), J(K, { key: 0 }, [
				(q(!0), J(K, null, W(l.value, (e) => (q(), J("path", {
					key: e.from,
			...
			X("div", Eo, [n[2] ||= X("span", null, "0", -1), X("span", null, P(e.maximum), 1)]),
			X("p", Do, P(c.value), 1),
			s.value ? (q(), J("p", Oo, P(s.value), 1)) : Z("", !0)
		], 8, So)])) : Z("", !0);
	}
	...
	key: 0,
	class: "entity-value"
}, jo = { class: "entity-value__name" }, Mo = { class: "entity-value__state" }, No = /*#__PURE__*/ bo(/* @__PURE__ */ U({
	__name: "EntityValue",
	props: {
		domain: { type: null },
		entityKey: { type: String }
	...
	setup(e) {
		...
		return (e, t) => r.value ? (q(), J("div", Ao, [X("span", jo, P(r.value.name), 1), X("span", Mo, P(r.value.displayValue), 1)])) : Z("", !0);
	}
...
}, Ro = ["aria-labelledby"], zo = ["id"], Bo = { class: "general-view__rows" }, Vo = /*#__PURE__*/ bo(/* @__PURE__ */ U({
	__name: "GeneralView",
	setup(e) {
		...
		return (e, i) => (q(), J("div", Po, [
			!V(t)?.ready.value && !V(t)?.error.value ? (q(), J("p", Fo, P(r.value.loading), 1)) : V(t)?.ready.value && !s.value ? (q(), J("p", Io, P(r.value.empty), 1)) : Z("", !0),
			...
			(q(!0), J(K, null, W(a.value, (e) => (q(), J("section", {
				key: e.title,
				class: N(["general-view__card", `general-view__card--${e.title}`]),
				"aria-labelledby": `${V(n)}-${e.title}`
			}, [X("h2", { id: `${V(n)}-${e.title}` }, P(r.value[e.title]), 9, zo), X("div", Bo, [(q(!0), J(K, null, W(e.entities, ([e, t]) => (q(), J(K, { key: `${e}.${t}` }, [e === "number" || e === "switch" ? (q(), Y(xo, {
				key: 0,
				domain: e,
				"entity-key": t,
...
}, rs = { class: "month-selection__missing-target" }, is = ["aria-describedby"], as = ["id"], os = /*#__PURE__*/ bo(/* @__PURE__ */ U({
	...
	setup(e) {
		...
		return (e, t) => (q(), J("div", {
			...
			X("div", Uo, [X("div", Wo, [X("p", Go, P(d.value), 1), X("p", Ko, P(f.value), 1)]), X("button", {
				type: "button",
				class: "month-selection__toggle",
				"aria-expanded": r.value,
				"aria-controls": i,
				onClick: t[0] ||= (e) => r.value = !r.value
			}, [li(P(r.value ? o.value.close : o.value.edit) + " ", 1), (q(), J("svg", {
				viewBox: "0 0 24 24",
				width: "18",
				height: "18",
				"aria-hidden": "true",
			...
			X("div", Jo, [
				r.value ? Z("", !0) : (q(), J(K, { key: 0 }, [(q(!0), J(K, null, W(m.value, (e) => (q(), J("p", {
					key: e,
					class: "month-selection__error",
					role: "alert"
				}, P(e), 1))), 128)), p.value ? (q(), J("p", Yo, P(o.value.pending), 1)) : Z("", !0)], 64)),
				V(n)?.connected.value ? Z("", !0) : (q(), J("p", Xo, P(o.value.disconnected), 1)),
				u.value.length ? (q(), J("p", Zo, P(o.value.unknown) + ": " + P(u.value.map((e) => e.name).join(", ")), 1)) : Z("", !0),
				h.value.length ? (q(), J("p", Qo, P(o.value.readOnly) + ": " + P(h.value.map((e) => e.name).join(", ")), 1)) : Z("", !0)
			]),
			Tn(X("div", {
				id: i,
				class: "month-selection__details"
			}, [X("p", $o, P(o.value.hint), 1), X("div", es, [(q(!0), J(K, null, W(c.value, (e) => (q(), J("fieldset", {
				key: e.index,
				class: "month-selection__quarter"
			}, [X("legend", null, P(e.name), 1), X("div", ts, [(q(!0), J(K, null, W(e.months, (e) => (q(), J(K, { key: e.index }, [e.entity && e.key ? (q(), Y(xo, {
				key: 0,
				domain: "switch",
				"entity-key": e.key,
				"month-tile": "",
				"hide-confirmed-value": ""
			}, null, 8, ["entity-key"])) : (q(), J("div", ns, [X("label", rs, [X("span", null, P(e.name), 1), X("input", {
				type: "checkbox",
				role: "switch",
				disabled: "",
				indeterminate: !0,
				"aria-describedby": `${i}-${e.index}-missing`
			}, null, 8, is)]), X("p", { id: `${i}-${e.index}-missing` }, P(o.value.unavailable), 9, as)]))], 64))), 128))])]))), 128))])], 512), [[Ki, r.value]])
		], 8, Ho));
	}
	...
	setup(e) {
		...
		return (e, t) => r.value || i.value ? (q(), J("form", {
			...
			X("div", cs, [(q(!0), J(K, null, W(ie.value, (e) => (q(), J("label", {
				key: e.key,
				for: `${a}-${e.key}`,
				class: "time-window-control__field"
			}, [X("span", null, [li(P(e.name), 1), s.value.unit ? (q(), J(K, { key: 0 }, [li(" (" + P(s.value.unit) + ")", 1)], 64)) : Z("", !0)]), X("input", {
				id: `${a}-${e.key}`,
				type: "time",
				step: "60",
				required: "",
			...
			}, P(s.value.apply), 9, ds)]),
			X("p", {
				id: `${a}-confirmed`,
				class: "time-window-control__confirmed"
			}, P(s.value.confirmed) + ": " + P(ee.value), 9, fs),
			X("div", {
				...
				ref_key: "rail",
				ref: d,
				class: N(["time-window-control__rail", { "time-window-control__rail--draft": E.value }])
			}, [(q(!0), J(K, null, W(re.value, (e, t) => (q(), J("span", {
				key: t,
				class: "time-window-control__segment",
				style: se(e)
			}, null, 4))), 128))], 2), (q(!0), J(K, null, W(ie.value, (e) => (q(), J("button", {
				key: e.key,
				type: "button",
				role: "slider",
			...
			}, [X("span", hs, P(e.shortName), 1), t[0] ||= X("span", {
			...
			X("p", gs, [X("span", null, P(E.value ? s.value.draft : s.value.duration) + ":", 1), li(" " + P(ne.value), 1)]),
			X("p", {
				id: `${a}-help`,
			...
			}, [k.value ? (q(), J("p", ys, P(k.value), 1)) : A.value ? (q(), J("p", bs, P(A.value), 1)) : Z("", !0)], 8, vs)
		], 40, ss)) : Z("", !0);
	}
...
}, Es = ["aria-labelledby"], Ds = ["id"], Os = /*#__PURE__*/ bo(/* @__PURE__ */ U({
	...
	setup(e) {
		...
		return (t, l) => (q(), J("div", Ss, [
			!V(n)?.ready.value && !V(n)?.error.value ? (q(), J("p", Cs, P(c.value.loading), 1)) : V(n)?.ready.value && !s.value && !a.value.length ? (q(), J("p", ws, P(c.value.empty), 1)) : Z("", !0),
			s.value ? (q(), Y(xo, {
				key: 2,
				domain: "switch",
			...
			o.value.length ? (q(), J("div", Ts, [(q(!0), J(K, null, W(o.value, (t) => (q(), J("div", {
				key: t.key,
				class: N(["charging-view__group", { "charging-view__group--wide": t.wide }])
			}, [(q(!0), J(K, null, W(t.cards, (t) => (q(), J("section", {
				key: t.key,
				class: "charging-view__card",
				"aria-labelledby": `${V(r)}-${t.key}`
			}, [
				X("h2", { id: `${V(r)}-${t.key}` }, P(t.title[i.value]), 9, Ds),
				...
				}, null, 8, ["entity-keys"])) : (q(!0), J(K, { key: 1 }, W(t.entities, ([t, n]) => (q(), J(K, { key: `${t}.${n}` }, [t === "switch" || t === "number" || t === "time" || t === "select" ? (q(), Y(xo, {
					key: 0,
					domain: t,
					"entity-key": n,
					"hide-confirmed-label": e.hideConfirmedLabel
...
var zs = { class: "savings-view" }, Bs = { class: "savings-overview" }, Vs = ["aria-labelledby"], Hs = ["id"], Us = ["aria-labelledby"], Ws = ["id"], Gs = {
	...
	setup(e) {
		...
		}), T = (e) => w.value && Ms(e.price_eur_kwh) !== null && ee.value?.start === e.start && ee.value?.end === e.end, E = $(() => w.value && ee.value === null && Ms(b.value.base_price_eur_kwh) !== null), D = (e) => Fs(`2000-01-01T${e.length === 5 ? `${e}:00` : e}Z`, t.hass, {
			timeStyle: "short",
			timeZone: "UTC"
		}) ?? e.slice(0, 5), O = Rs(() => t.hass, () => t.entryId, () => u.value?.metadata.entity_id), k = /* @__PURE__ */ B(""), A = /* @__PURE__ */ B(""), te = null;
		jn(O.data, (e) => {
		...
		let M = $(() => {
			let e = re.value.map((e) => Ms(e.change)), n = Math.max(0, ...e.map((e) => e ?? 0)), r = Math.min(0, ...e.map((e) => e ?? 0)), i = n - r || 1, a = (e) => 20 + (n - e) / i * 180, o = O.data.value?.selected, s = Date.parse(o?.start ?? ""), c = Date.parse(o?.end ?? ""), l = c - s, u = Ps(n, t.hass) ?? "", d = Ps(r, t.hass) ?? "", f = Math.max(56, Math.max(u.length, d.length) * 7.1 + 12), p = ae.value - 24, m = Math.max(1, p - f), h = (e) => f + Math.max(0, Math.min(1, (Date.parse(e) - s) / l)) * m;
			return {
				zero: a(0),
				high: n,
				low: r,
		...
		}), oe = $(() => re.value.some((e) => Ms(e.change) !== null)), ce = (e) => Fs(e, t.hass, O.data.value?.selected.period === "hour" ? { timeStyle: "short" } : O.data.value?.selected.period === "month" ? {
			month: "short",
			year: "numeric"
		} : {
			day: "2-digit",
		...
		return (t, i) => (q(), J("div", zs, [
			X("div", Bs, [o.value?.available && o.value.state?.state === "off" ? (q(), J("section", {
			...
			}, [X("h2", { id: `${V(r)}-investment` }, P(a.value.payback), 9, Hs), X("p", null, P(a.value.investment), 1)], 8, Vs)) : o.value?.available && o.value.state?.state === "on" && (s.value || c.value || l.value || u.value || d.value) ? (q(), J("section", {
				key: 1,
				class: "savings-card savings-payback",
				"aria-labelledby": `${V(r)}-payback`
			}, [
				X("h2", { id: `${V(r)}-payback` }, P(a.value.payback), 9, Ws),
				s.value ? (q(), J("div", Gs, [
					X("h3", { id: `${V(r)}-progress` }, P(s.value.name), 9, Ks),
					X("p", qs, P(p.value === null ? a.value.unavailable : `${V(Ps)(p.value, e.hass)} %`), 1),
					X("div", {
				...
				c.value || l.value || u.value || d.value ? (q(), J("dl", Ys, [
					c.value ? (q(), J("div", Xs, [X("dt", null, P(c.value.name), 1), X("dd", null, P(h(c.value.available ? c.value.state?.state : null)), 1)])) : Z("", !0),
					...
					u.value ? (q(), J("div", Qs, [X("dt", null, P(a.value.net), 1), X("dd", null, P(h(u.value.available ? u.value.state?.state : null)), 1)])) : Z("", !0),
					d.value ? (q(), J("div", $s, [X("dt", null, P(a.value.started), 1), X("dd", null, P(_(d.value.available ? d.value.state?.attributes.economics_started_at : null)), 1)])) : Z("", !0)
				])) : Z("", !0)
			], 8, Us)) : Z("", !0), u.value ? (q(), J("section", {
				key: 2,
				class: "savings-periods",
				"aria-label": a.value.periods
			}, [(q(), J(K, null, W(ne, (e) => X("article", {
				key: e,
				class: "savings-card"
			}, [X("h2", null, P(a.value[e]), 1), X("p", tc, P(V(O).loading.value ? "…" : h(V(O).data.value?.periods[e].change)), 1)])), 64))], 8, ec)) : Z("", !0)]),
			x.value ? (q(), J("section", {
				key: 0,
				class: "savings-card savings-tariff",
				"aria-labelledby": `${V(r)}-tariff`
			}, [
				X("h2", { id: `${V(r)}-tariff` }, P(a.value.tariff), 9, rc),
				X("div", ic, [X("table", ac, [X("thead", null, [X("tr", null, [
				...
				])]), X("tbody", null, [(q(!0), J(K, null, W(S.value, (e, t) => (q(), J("tr", {
					key: t,
					class: N({ "savings-current": T(e) })
				}, [
					X("td", null, P(T(e) ? a.value.now : ""), 1),
					...
					X("td", oc, P(a.value.base), 1),
					X("td", null, P(g(b.value.base_price_eur_kwh)), 1)
				], 2)])])]),
				X("p", null, [X("strong", null, P(a.value.feed) + ":", 1), li(" " + P(g(b.value.feed_in_price_eur_kwh)), 1)]),
				w.value ? b.value.next_price_change_at ? (q(), J("p", lc, [X("strong", null, P(a.value.next) + ":", 1), li(" " + P(_(b.value.next_price_change_at)), 1)])) : Z("", !0) : (q(), J("p", sc, [li(P(a.value.noPrice), 1), typeof C.value == "string" && C.value ? (q(), J("span", cc, " (" + P(C.value) + ")", 1)) : Z("", !0)]))
			], 8, nc)) : Z("", !0),
			u.value ? (q(), J("section", {
				key: 1,
				...
				X("h2", { id: `${V(r)}-range` }, P(a.value.range), 9, dc),
				X("form", {
					class: "savings-dates",
					onSubmit: i[3] ||= Fa((e) => V(O).select(k.value, A.value), ["prevent"])
				}, [
					X("label", { for: `${V(r)}-from` }, [li(P(a.value.from), 1), Tn(X("input", {
						id: `${V(r)}-from`,
						"onUpdate:modelValue": i[0] ||= (e) => k.value = e,
						type: "date",
						required: "",
						max: A.value || void 0
					}, null, 8, pc), [[Ma, k.value]])], 8, fc),
					X("label", { for: `${V(r)}-to` }, [li(P(a.value.to), 1), Tn(X("input", {
						id: `${V(r)}-to`,
						"onUpdate:modelValue": i[1] ||= (e) => A.value = e,
						type: "date",
						required: "",
						min: k.value || void 0
					}, null, 8, hc), [[Ma, A.value]])], 8, mc),
					X("button", gc, P(a.value.apply), 1),
					X("button", {
						type: "button",
						disabled: V(O).loading.value,
						onClick: i[2] ||= (...e) => V(O).refresh && V(O).refresh(...e)
					}, P(a.value.refresh), 9, _c)
				], 32),
				V(O).loading.value ? (q(), J("p", vc, P(a.value.loading), 1)) : j.value ? (q(), J("p", yc, P(j.value), 1)) : V(O).data.value ? (q(), J(K, { key: 2 }, [
					X("p", bc, P(v(V(O).data.value.selected.start_date)) + " – " + P(v(V(O).data.value.selected.end_date)), 1),
					X("h3", null, P(a.value.selected), 1),
					X("p", xc, P(h(V(O).data.value.selected.change)), 1),
					X("h3", { id: `${V(r)}-chart` }, P(a.value.chart), 9, Sc),
					X("p", Cc, P(a.value.chartHint), 1),
					oe.value ? (q(), J(K, { key: 0 }, [(q(), J("svg", {
						...
						X("desc", { id: `${V(r)}-chart-description` }, P(a.value.net) + ": " + P(h(V(O).data.value.selected.change)) + ". " + P(a.value.table) + ". ", 9, Tc),
						X("line", {
							x1: M.value.left - 2,
							x2: M.value.right + 2,
							y1: M.value.zero,
						...
						X("text", {
							...
							y: "24",
							"text-anchor": "end"
						}, P(M.value.highLabel), 9, Dc),
						X("text", {
							x: M.value.left - 8,
							y: "204",
							"text-anchor": "end"
						}, P(M.value.lowLabel), 9, Oc),
						i[5] ||= X("text", {
							x: "10",
							y: "226"
						}, "EUR", -1),
						re.value.length ? (q(), J("text", {
							...
							x: M.value.left,
							y: "226"
						}, P(ce(M.value.start)), 9, kc)) : Z("", !0),
						re.value.length > 1 ? (q(), J("text", {
							key: 1,
							x: M.value.right,
							y: "226",
							"text-anchor": "end"
						}, P(ce(M.value.end)), 9, Ac)) : Z("", !0),
						(q(!0), J(K, null, W(M.value.bars, (e, t) => (q(), J("rect", {
							key: t,
							x: e.x,
							y: e.y,
							width: e.width,
						...
						}, [X("title", null, P(e.label) + ": " + P(h(e.value)), 1)], 10, jc))), 128))
					], 8, wc)), X("details", Mc, [X("summary", null, P(a.value.table), 1), X("div", Nc, [X("table", Pc, [X("thead", null, [X("tr", null, [
						X("th", null, P(a.value.from), 1),
						X("th", null, P(a.value.to), 1),
						X("th", null, P(a.value.net), 1)
					])]), X("tbody", null, [(q(!0), J(K, null, W(M.value.bars, (e, t) => (q(), J("tr", { key: t }, [
						X("td", null, P(e.label), 1),
						X("td", null, P(_(e.end)), 1),
						X("td", null, P(h(e.value)), 1)
					]))), 128))])])])])], 64)) : Z("", !0),
					!oe.value || V(O).data.value.selected.change === null ? (q(), J("p", Fc, P(V(O).data.value.selected.change === null ? a.value.noData : a.value.noChartData), 1)) : Z("", !0)
				], 64)) : Z("", !0)
			], 8, uc)) : Z("", !0),
			X("details", Ic, [
			...
			y.value && V(n)?.ready.value ? (q(), J("p", Lc, P(y.value), 1)) : Z("", !0)
		]));
	}
	...
	key: 7,
	class: "status"
}, Xc = ["href"], Zc = /* @__PURE__ */ Sa(/* @__PURE__ */ bo(/* @__PURE__ */ U({
	__name: "Panel.ce",
	props: {
		hass: { type: Object },
		narrow: { type: Boolean },
	...
	setup(e) {
		...
		return (t, n) => (q(), J("div", {
			...
			}, [(q(!0), J(K, null, W(u.value, (e) => (q(), J("a", {
				key: e.path,
				href: `${s.value}/${e.path}`,
				"aria-current": f.value === e.path ? "page" : void 0,
				onClick: (t) => g(t, `${s.value}/${e.path}`)
			}, P(e[i.value]), 9, Uc))), 128))], 8, Hc),
			X("main", null, [
				V(r).error.value ? (q(), J("p", Wc, P(V(r).error.value), 1)) : Z("", !0),
				X("p", Gc, P(a.value.introduction), 1),
				X("section", Kc, [X("h1", {
					id: "section-heading",
					ref_key: "heading",
					ref: m,
					tabindex: "-1"
				}, P(p.value?.[i.value] ?? a.value.notFound), 513), e.hass ? e.panel?.config?.entry_id ? f.value === "allgemein" ? (q(), Y(Vo, { key: 2 })) : f.value === "ladeautomatik" ? (q(), Y(ks, { key: 3 })) : f.value === "netzdienliches-laden" ? (q(), Y(As, { key: 4 })) : f.value === "dynamisches-laden" ? (q(), Y(js, { key: 5 })) : f.value === "ersparnis" ? (q(), Y(Rc, {
					key: 6,
					hass: e.hass,
					"entry-id": e.panel?.config?.entry_id
				}, null, 8, ["hass", "entry-id"])) : (q(), J("div", Yc, [X("p", null, P(a.value.notFoundDescription), 1), X("a", {
					href: `${s.value}/allgemein`,
					onClick: n[0] ||= (e) => g(e, `${s.value}/allgemein`)
				}, P(a.value.returnToOverview), 9, Xc)])) : (q(), J("p", Jc, P(a.value.missingEntry), 1)) : (q(), J("p", qc, P(a.value.loading), 1))])
			])
		], 10, zc));
	}
